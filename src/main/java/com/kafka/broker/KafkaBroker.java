...
public class KafkaBroker {
    ...
    public void start() throws IOException {
        ...
        System.out.println("SimpleKafka broker started on port " + port);
        ...
        try {
            while (running) {
                ...
                System.out.println("Accepted connection #" + connectionId + " from " + clientSocket.getRemoteSocketAddress());

                configureSocket(clientSocket);

                connectionPool.submit(new ClientConnection(connectionId, clientSocket));
            }
